...
\begin{document}
	...
	\begin{enumerate}
		...
		فرض کنید $L$ زبانی دلخواه و $ S $ مجموعه‌ای از رشته های دو به دو
		 \lr{$L$-distinguishable} 
		نسبت به زبان پذیرفته شده توسط ماشین زیر باشند. $|S|$ حداکثر چقدر است؟ ادعای خود را اثبات کنید. در نهایت مجموعه‌ای از اندازه $|S|$ ارائه دهید که اعضای آن دو به دو \lr{$L$-distinguishable} باشند.
		\begin{figure}[h]
			\centering
